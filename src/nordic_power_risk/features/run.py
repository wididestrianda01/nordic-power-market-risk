...
from nordic_power_risk.reserves import RESERVE_PRODUCTS, fact_table, feature_table
...
_SECONDARY_TARGETS = [
    *[(fact_table(p, d), feature_table(p, d), "price", None) for p, d in RESERVE_PRODUCTS],
    (
